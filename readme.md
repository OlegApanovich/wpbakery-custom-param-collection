...
This is a collection of additional [WPBakery Page Builder](https://wpbakery.com/) [custom element param types]([https://wpbakery.com/](https://kb.wpbakery.com/docs/developers-how-tos/create-new-param-type) for [WPBakery Page Builder](https://wpbakery.com/) wordpress plugin.
